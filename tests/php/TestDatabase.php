...
final class TestDatabase
{
    ...
    public static function reset(): void
    {
        ...
        $tables = ['warnemuende_teilnehmer', 'mitglied_aenderung', 'mitglied_passbild', 'mitglied_funktion', 'mitglied_interessengruppe', 'mitglied', 'app_session', 'app_user', ...self::REFERENCE_TABLES];
        $pdo->exec('SET FOREIGN_KEY_CHECKS = 0');
